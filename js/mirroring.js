...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(188);
	
	var _componentsApp2 = _interopRequireDefault(_componentsApp);
	
	var _componentsIntro = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inherits = __webpack_require__(175)['default'];
	
	var _createClass = __webpack_require__(185)['default'];
	
	var _classCallCheck = __webpack_require__(184)['default'];
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							"svg",
							{ width: "234", height: "48", viewBox: "0 0 234 48", xmlns: "http://www.w3.org/2000/svg" },
							_react2["default"].createElement("path", { d: "M40.625 4.5h-10.15l-9.85 18.3-9.8-18.3H.675V38h9.4V22.95L17.525 38h6.25l7.45-15.15V38h9.4V4.5zm9.8-4.25c-1.5 0-2.75.5-3.75 1.5s-1.5 2.2-1.5 3.6c0 1.467.492 2.683 1.475 3.65.983.967 2.242 1.45 3.775 1.45S53.217 9.967 54.2 9c.983-.967 1.475-2.183 1.475-3.65 0-1.367-.5-2.558-1.5-3.575-1-1.017-2.25-1.525-3.75-1.525zm4.7 37.75V12.75h-9.35V38h9.35zm22.9-25.55c-3.733 0-6.533 1.767-8.4 5.3v-5h-9.35V38h9.35v-7.65c0-2.9.717-4.975 2.15-6.225 1.433-1.25 3.5-1.875 6.2-1.875h1.5l.35-9.65c-.433-.1-1.033-.15-1.8-.15zm42.35-.4c3.933 0 7.275 1.25 10.025 3.75s4.125 5.7 4.125 9.6c0 3.9-1.375 7.092-4.125 9.575-2.75 2.483-6.092 3.725-10.025 3.725-3.933 0-7.275-1.242-10.025-3.725s-4.125-5.675-4.125-9.575c0-3.9 1.375-7.1 4.125-9.6s6.092-3.75 10.025-3.75zm0 18.9c1.4 0 2.608-.533 3.625-1.6 1.017-1.067 1.525-2.383 1.525-3.95 0-1.567-.5-2.883-1.5-3.95-1-1.067-2.217-1.6-3.65-1.6-1.433 0-2.65.533-3.65 1.6-1 1.067-1.5 2.383-1.5 3.95 0 1.567.508 2.883 1.525 3.95 1.017 1.067 2.225 1.6 3.625 1.6zm35.25-18.5c-3.733 0-6.533 1.767-8.4 5.3v-5h-9.35V38h9.35v-7.65c0-2.9.717-4.975 2.15-6.225 1.433-1.25 3.5-1.875 6.2-1.875h1.5l.35-9.65c-.433-.1-1.033-.15-1.8-.15zm9.55-12.2c-1.5 0-2.75.5-3.75 1.5s-1.5 2.2-1.5 3.6c0 1.467.492 2.683 1.475 3.65.983.967 2.242 1.45 3.775 1.45s2.792-.483 3.775-1.45c.983-.967 1.475-2.183 1.475-3.65 0-1.367-.5-2.558-1.5-3.575-1-1.017-2.25-1.525-3.75-1.525zm4.7 37.75V12.75h-9.35V38h9.35zm22.1-26c-3.033 0-5.567 1.1-7.6 3.3v-2.55h-9.35V38h9.35V25.75c0-1.733.375-3.067 1.125-4 .75-.933 1.758-1.4 3.025-1.4 1.067 0 1.925.367 2.575 1.1.65.733.975 1.7.975 2.9V38h9.4V22.35c0-3.167-.867-5.683-2.6-7.55s-4.033-2.8-6.9-2.8zm41.35.75l.05 22.7c0 3.767-1.4 6.717-4.2 8.85-2.8 2.133-6.35 3.2-10.65 3.2-6.067 0-10.383-2.217-12.95-6.65l7.9-3.1c.867 1 1.667 1.675 2.4 2.025.733.35 1.6.525 2.6.525 1.633 0 2.975-.442 4.025-1.325 1.05-.883 1.575-2.175 1.575-3.875V34c-1.767 1.7-4.183 2.55-7.25 2.55-3.5 0-6.4-1.15-8.7-3.45-2.3-2.3-3.45-5.267-3.45-8.9 0-3.567 1.15-6.492 3.45-8.775 2.3-2.283 5.2-3.425 8.7-3.425 3.067 0 5.483.85 7.25 2.55v-1.8h9.25zm-14.3 16.4c-1.5 0-2.717-.475-3.65-1.425-.933-.95-1.4-2.125-1.4-3.525 0-1.433.467-2.625 1.4-3.575.933-.95 2.15-1.425 3.65-1.425 1.433 0 2.625.483 3.575 1.45.95.967 1.425 2.15 1.425 3.55s-.475 2.575-1.425 3.525c-.95.95-2.142 1.425-3.575 1.425zM85.55 12.45c3.733 0 6.533 1.767 8.4 5.3v-5h9.35V38h-9.35v-7.65c0-2.9-.717-4.975-2.15-6.225-1.433-1.25-3.5-1.875-6.2-1.875h-1.5l-.35-9.65c.433-.1 1.033-.15 1.8-.15z", fill: "#FFF", "fill-rule": "evenodd" })
						)
					),
					_react2["default"].createElement(
						"p",
						{ className: "description" },
						"Device Mirroring Game"
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DevicePreview = (function (_React$Component) {
		_inherits(DevicePreview, _React$Component);
	
		function DevicePreview() {
			_classCallCheck(this, DevicePreview);
	
			_get(Object.getPrototypeOf(DevicePreview.prototype), 'constructor', this).apply(this, arguments);
		}
	
		_createClass(DevicePreview, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement('div', { style: { paddingLeft: this.positions.left } });
			}
		}, {
			key: 'componentWillMount',
			value: function componentWillMount() {
